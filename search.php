		  ...
		  <a class="navbar-brand" href="index.html"><i class="fas fa-database"></i> Sistem Information</a>
		    ...
		    <div class="collapse navbar-collapse" 
		      ...
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        ...
		        <li class="nav-item">
		          <a class="nav-link" 
		             href="https://github.com/moaditPENS/Final_Project_Web.git"><i class="bi-github"></i> My Github</a>
		        </li>
		        <li class="nav-item">
   					 <a class="nav-link btn btn-info" href="videos.html"><i class="fas fa-tools"></i> Tools</a>
				</li>
		        <li class="nav-item">
